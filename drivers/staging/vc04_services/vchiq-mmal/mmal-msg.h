...
struct mmal_msg_event_format_changed {
	u32 buffer_size_min;		/* Minimum size of buffers required */
	u32 buffer_num_min;		/* Minimum number of buffers required */
	u32 buffer_size_recommended;	/* Size of buffers the port recommends
					 * for optimal performance.
					 * A value of zero means no special
					 * recommendation.
					 */
	u32 buffer_num_recommended;	/* Number of buffers the port recommends
					 * for optimal performance. A value of
					 * zero means no special recommendation.
					 */
	u32 es_ptr;
	struct mmal_es_format format;
	union mmal_es_specific_format es;
