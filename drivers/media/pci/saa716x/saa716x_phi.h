...
extern int saa716x_phi_write(struct saa716x_dev *saa716x, u32 address,
			     const u8 *data, int length);
extern int saa716x_phi_read(struct saa716x_dev *saa716x, u32 address, u8 *data,
			    int length);
extern int saa716x_phi_write_fifo(struct saa716x_dev *saa716x, const u8 *data,
				  int length);
