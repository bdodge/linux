 ...
 * IMX327 supports up to 60fps, whilst IMX290 supports up to 120fps but
 * only 10bit and when connected over 4 CSI-2 lanes.
 * This driver currently does not support the 120fps mode, so runs equally
 * well on either sensor.
 *
