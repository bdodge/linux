...
#define IMX290_HMAX_MIN_4LANE 2200 /* Min of 200 pixels = 60fps */
...
static const struct imx290_pixfmt imx290_colour_formats[] = {
	{ MEDIA_BUS_FMT_SRGGB10_1X10, 10 },
	{ MEDIA_BUS_FMT_SRGGB12_1X12, 12 },
};

static const struct imx290_pixfmt imx290_mono_formats[] = {
...
static const struct imx290_mode imx290_modes_2lanes[] = {
	{
		...
		.clk_data = {
			imx290_37_125mhz_clock_1080p,
			imx290_74_250mhz_clock_1080p,
		},
...
static const struct imx290_mode imx290_modes_4lanes[] = {
	{
		...
		.data_size = ARRAY_SIZE(imx290_1080p_settings),
		.clk_data = {
			imx290_37_125mhz_clock_720p,
			imx290_74_250mhz_clock_720p,
		},
				 ...
				 struct v4l2_subdev_mbus_code_enum *code)
{
	...
	if (code->index >= imx290->num_formats)
		return -EINVAL;
		      ...
		      struct v4l2_subdev_format *fmt)
{
	...
	for (i = 0; i < imx290->num_formats; i++)
		if (imx290->formats[i].code == fmt->format.code)
			break;

	if (i >= imx290->num_formats)
		i = 0;
...
static const struct of_device_id imx290_of_match[] = {
	{ .compatible = "sony,imx290", .data = (void *)0 },
...
static int imx290_probe(struct i2c_client *client)
{
	...
	if (!match)
		return -ENODEV;
	if (!match->data) {
		imx290->formats = imx290_colour_formats;
		imx290->num_formats = ARRAY_SIZE(imx290_colour_formats);
	} else {
		imx290->formats = imx290_mono_formats;
		imx290->num_formats = ARRAY_SIZE(imx290_mono_formats);
	}
