...
extern struct dvb_frontend *tas2101_attach(const struct tas2101_config *cfg,
					   struct i2c_adapter *i2c);
extern struct i2c_adapter *tas2101_get_i2c_adapter(struct dvb_frontend *fe, int bus);
#else
static inline struct dvb_frontend *tas2101_attach(const struct tas2101_config *cfg,
						  struct i2c_adapter *i2c)
{
