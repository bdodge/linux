...
static void v4l_fill_fmtdesc(struct v4l2_fmtdesc *fmt)
{
	...
	case V4L2_PIX_FMT_NV12_COL128:	descr = "Y/CbCr 4:2:0 (128 pixel columns)"; break;
	case V4L2_PIX_FMT_NV12_10_COL128: descr = "10-bit Y/CbCr 4:2:0 (128 byte/96 pixel columns)"; break;
